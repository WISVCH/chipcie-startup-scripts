...
# ARG_POSITIONAL_SINGLE([password],[Password of the judgehosts in the domserver])
...
{
	local first_option all_short_options='hucv'
	first_option="${1:0:1}"
...
print_help()
{
	...
	printf 'Usage: %s [-h|--help] [-u|--domserver-baseurl <arg>] [-c|--container <arg>] [-v|--version <arg>] <password>\n' "$0"
	printf '\t%s\n' "<password>: Password of the judgehosts in the domserver"
	printf '\t%s\n' "-h, --help: Prints help"
...
{
	local _required_args_string="'password'"
...
assign_positional_args()
{
	...
	_positional_names="_arg_password "
